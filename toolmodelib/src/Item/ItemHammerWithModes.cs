...
public class ItemHammerWithModes : Item
{
    ...
    public override void OnHeldAttackStart(ItemSlot slot, EntityAgent byEntity, BlockSelection blockSel, EntitySelection entitySel, ref EnumHandHandling handHandling)
    {
        ...
        if((be is not BlockEntityAnvilPart) && (byEntity.World.BlockAccessor.GetBlock(blockSel.Position) is not BlockAnvil)) {
            base.OnHeldAttackStart(slot, byEntity, blockSel, entitySel, ref handHandling);
            return;
        }
    ...
    public override void OnHeldActionAnimStart(ItemSlot slot, EntityAgent byEntity, EnumHandInteract type)
    {
        ...
        AccessTools.Method(typeof(BlockEntityAnvil), "OnBeginUse").Invoke(bea, new object[] { byPlayer, blockSel });
    ...
    protected virtual void strikeAnvil(EntityAgent byEntity, ItemSlot slot)
    {
        ...
        else
        {
            ...
            {
                AccessTools.Method(typeof(BlockEntityAnvil), "OnUseOver", new Type[] { typeof(IPlayer), typeof(int) }).Invoke(bea, new object[] {byPlayer, blockSel.SelectionBoxIndex} );
            }
        }
    ...
    public static void DrawHit(Context cr, int x, int y, float width, float height, double[] colordoubles)
    {
        Pattern pattern = null;
        Matrix matrix = cr.Matrix;
...
public abstract class ToolModeHammer : ToolMode
{
    public ToolModeHammer(AssetLocation group) : base(group)
    { }
    ...
    public override bool ShouldDisplay(CollectibleObject collObj, ItemSlot slot, IClientPlayer forPlayer, BlockSelection blockSel)
    {
        ...
        return block is BlockAnvil;
    }
}

public class ToolModeHammerHit : ToolModeHammer
{
    SkillItem skillItem;

    public ToolModeHammerHit(AssetLocation group) : base(group)
    { }
    ...
    public override void OnLoaded(ICoreAPI api)
    {
        ...
        }.WithIcon(api as ICoreClientAPI, ItemHammerWithModes.DrawHit);
    }
...
public class ToolModeHammerUpsetUp : ToolModeHammer
{
    SkillItem skillItem;

    public ToolModeHammerUpsetUp(AssetLocation group) : base(group)
    { }
    ...
    public override void OnLoaded(ICoreAPI api)
    {
        ...
        }.WithIcon(api as ICoreClientAPI, (cr, x, y, w, h, c) => ItemHammerWithModes.DrawUpset(cr, x, y, w, h, c, 0));
    }
...
public class ToolModeHammerUpsetRight : ToolModeHammer
{
    SkillItem skillItem;

    public ToolModeHammerUpsetRight(AssetLocation group) : base(group)
    { }
    ...
    public override void OnLoaded(ICoreAPI api)
    {
        ...
        }.WithIcon(api as ICoreClientAPI, (cr, x, y, w, h, c) => ItemHammerWithModes.DrawUpset(cr, x, y, w, h, c, GameMath.PI / 2));
    }
...
public class ToolModeHammerUpsetDown : ToolModeHammer
{
    SkillItem skillItem;

    public ToolModeHammerUpsetDown(AssetLocation group) : base(group)
    { }
    ...
    public override void OnLoaded(ICoreAPI api)
    {
        ...
        }.WithIcon(api as ICoreClientAPI, (cr, x, y, w, h, c) => ItemHammerWithModes.DrawUpset(cr, x, y, w, h, c, GameMath.PI));
    }
...
public class ToolModeHammerUpsetLeft : ToolModeHammer
{
    SkillItem skillItem;

    public ToolModeHammerUpsetLeft(AssetLocation group) : base(group)
    { }
    ...
    public override void OnLoaded(ICoreAPI api)
    {
        ...
        }.WithIcon(api as ICoreClientAPI, (cr, x, y, w, h, c) => ItemHammerWithModes.DrawUpset(cr, x, y, w, h, c, 3 * GameMath.PI / 2));
    }
...
public class ToolModeHammerSplit : ToolModeHammer
{
    SkillItem skillItem;

    public ToolModeHammerSplit(AssetLocation group) : base(group)
    { }
    ...
    public override void OnLoaded(ICoreAPI api)
    {
        ...
        skillItem = new SkillItem() {
            Code = Code,
            Name = Lang.Get("Split")
        }.WithIcon(api as ICoreClientAPI, ItemHammerWithModes.DrawSplit);
    }
