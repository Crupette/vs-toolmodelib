...
public class ItemClayWithModes : Item
{
    public override void OnHeldInteractStart(ItemSlot slot, EntityAgent byEntity, BlockSelection blockSel, EntitySelection entitySel, bool firstEvent, ref EnumHandHandling handling)
    {
        ...
        if(handling == EnumHandHandling.PreventDefaultAction) return;
        if(byEntity.Controls.ShiftKey) {
            ...
            if(!belowBlock.CanAttachBlockAt(world.BlockAccessor, clayFormBlock, belowPos, BlockFacing.UP)) return;
            ...
            bec = world.BlockAccessor.GetBlockEntity(placePos) as BlockEntityClayForm;
...
public abstract class ToolModeClayMode : ToolMode
{
    public ToolModeClayMode(AssetLocation group) : base(group)
    {}
    ...
    public override bool ShouldDisplay(CollectibleObject collObj, ItemSlot slot, IClientPlayer forPlayer, BlockSelection blockSel)
    {
        ...
        return forPlayer.Entity.World.BlockAccessor.GetBlock(blockSel.Position) is BlockClayForm;
    }

    public override void OnHeldInteractStart(ItemSlot slot, EntityAgent byEntity, BlockSelection blockSel, EntitySelection entitySel, bool firstEvent, ref EnumHandHandling handHandling, ref EnumHandling handling)
    {
        if(blockSel == null) return;
        CollectibleObject collObj = slot.Itemstack.Collectible;

        BlockEntityClayForm bec = byEntity.World.BlockAccessor.GetBlockEntity(blockSel.Position) as BlockEntityClayForm;
        if(bec != null && bec.BaseMaterial.Collectible.Variant["type"] != collObj.Variant["type"]) return;
...
public class ToolModeClay1Size : ToolModeClayMode
{
    static SkillItem skillItem = null;

    public ToolModeClay1Size(AssetLocation group) : base(group)
    {}
...
public class ToolModeClay2Size : ToolModeClayMode
{
    static SkillItem skillItem = null;

    public ToolModeClay2Size(AssetLocation group) : base(group)
    {}
...
public class ToolModeClay3Size : ToolModeClayMode
{
    static SkillItem skillItem = null;

    public ToolModeClay3Size(AssetLocation group) : base(group)
    {}
    ...
    public static void Drawcreate9_svg(Context cr, int x, int y, float width, float height, double[] rgba)
        {
...
public class ToolModeClayDuplicate : ToolModeClayMode
{
    static SkillItem skillItem = null;

    public ToolModeClayDuplicate(AssetLocation group) : base(group)
    {}
    ...
    public static void Drawduplicate_svg(Context cr, int x, int y, float width, float height, double[] rgba)
        {
            Pattern pattern = null;
            Matrix matrix = cr.Matrix;
